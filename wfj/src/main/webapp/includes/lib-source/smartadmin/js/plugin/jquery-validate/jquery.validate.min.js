    ...
    $.extend($.validator, {
        ...
        methods: {
            required: function (value, element, param) {
                ...
                var remoteurl = param.url;
                if(typeof param.url == "function"){/*20150826 wud 兼容remote url传递动态参数*/
                    param.url = param.url.call();
                }
                if (previous.old === value) {
                    param.url = remoteurl;/*20150826 wud 兼容remote 将param.url 重置 否则验证后url会被置为string*/
                ...
                $.ajax($.extend(true, {
                    ...
                    success: function (response) {
                        ...
                        if (valid) {
                            ...
                            var errors = {};
                            var message = validator.defaultMessage(element, "remote") || response.message ;
