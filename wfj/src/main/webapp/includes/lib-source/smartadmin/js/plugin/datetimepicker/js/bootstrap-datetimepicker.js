...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		fill: function () {
			...
			for (var i = 0; i < 24; i++) {
				//if (hoursDisabled.indexOf(i) !== -1) continue;林淙源【2014年12月23日16:02:36】对此行做了注释
				if (!hoursDisabled && hoursDisabled.indexOf(i) !== -1) continue;
			...
			for (var i = 0; i < 60; i += this.minuteStep) {
				//if (minutesDisabled.indexOf(i) !== -1) continue;林淙源【2014年12月23日16:02:36】对此行做了注释
				if (!minutesDisabled && minutesDisabled.indexOf(i) !== -1) continue;
