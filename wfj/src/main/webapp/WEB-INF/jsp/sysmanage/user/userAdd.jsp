...
<div class="modal-header" style="height:55px;line-height:55px">
    <button type="button" id="useradd_close" class="close" data-dismiss="modal">
...
<form  method="post" id="useradd_form" class="smart-form form-horizontal">
    <fieldset>
        <section>
        ...
        <section>
            <div class="form-group">
                ...
                <div class="col-sm-8 col-xs-6">
                    <select class="col-sm-8 col-xs-6 form-control" id="rolename"  multiple></select>
    ...
    <footer>
        ...
        <button type="button" id="useradd_cancel" class="btn btn-primary">取消</button>
    </footer>
</form>

<script type="text/javascript">
    requirejs(['userAdd'], function (userAdd) {
        userAdd.init();
    });
</script>
