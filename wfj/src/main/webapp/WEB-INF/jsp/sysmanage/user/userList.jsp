...
<div class="content-main">
    <section class="col-sm-6 col-md-4 col-lg-3" style="height:100%;">
    ...
    <section class="col-sm-6 col-md-8 col-lg-9" style="height:100%;background-color: #fff;border:1px solid #ccc;">
        <div class="table-responsive">
            <table id="user_table"  class="table table-bordered table-hover" style="border-bottom-width: 0px;"></table>
        </div>
    </section>
</div>
...
<script type="text/javascript">
    requirejs(['userList'], function (user) {
        user.userTabinit();
    });
</script>