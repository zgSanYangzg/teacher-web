...
<div class="modal-header" style="height:55px;line-height:55px">
    <button type="button" id="peopleadd_close" class="close" data-dismiss="modal">
        <span aria-hidden="true">&times;</span>
        <span class="sr-only" >Close</span></button>
    <h4 class="modal-title">增加人员</h4>
</div>
<form  method="post" id="peopleadd_form" class="smart-form form-horizontal">
    <fieldset>
        <section>
    ...
    <footer>
        <button type="submit" id="peopleadd_save" class="btn btn-primary">保存</button>
        <button type="button" id="peopleadd_cancel" class="btn btn-primary">取消</button>
    </footer>
</form>
<script type="text/javascript">
    requirejs(['peopleAdd'], function (peopleAdd) {
        peopleAdd.init();
    });
</script>